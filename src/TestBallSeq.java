...
public class TestBallSeq extends LockedTestCase {
	...
	Ball b2a = new Ball(new Point(2.0,40.0),v,Color.MAGENTA);
	...
	@Override
	public void setUp() {
		s = new BallSeq(1); // start small
		try {
			assert 3/(int)(b1.getLoc().x()-1.0) == 42 : "OK";
	...
	public void test() {
		...
		// -2 none of the above (some other ball, such as b2a)
